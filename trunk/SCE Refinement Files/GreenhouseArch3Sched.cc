...
// File:   GreenhouseArch3Sched.cc
// Time:   Sun May  9 18:46:20 2010
//////////////////////////////////////////////////////////////////////
...
#include "GreenhouseArch3Sched.h"
...
#line 23 "GreenhouseArch3Sched.cc"
unsigned int __PRF_globalCounter[74];
...
#line 70 "GreenhouseArch3Sched.cc"
...
#line 103 "GreenhouseArch3Sched.cc"
...
#line 213 "GreenhouseArch3Sched.cc"
...
#line 229 "GreenhouseArch3Sched.cc"
...
#line 238 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[40u]++ ;
	__PRF_channelAccess(18256u, sizeof (h));

#line 26 "./HeatControl.sc"
	tempdatain.receive( &h, sizeof (h));

#line 245 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[41u]++ ;

#line 27 "./HeatControl.sc"
	if (h == 0)

#line 251 "GreenhouseArch3Sched.cc"
	{   
...
#line 260 "GreenhouseArch3Sched.cc"
	{   
...
#line 268 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[44u]++ ;

#line 31 "./HeatControl.sc"
	_specc::waitfor((10));

#line 274 "GreenhouseArch3Sched.cc"
	__PRF_channelAccess(18129u, sizeof (command));
...
#line 282 "GreenhouseArch3Sched.cc"
...
#line 334 "GreenhouseArch3Sched.cc"
	{   
...
#line 342 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[51u]++ ;
	__PRF_channelAccess(19130u, sizeof (command));

#line 30 "./MoistProcessing.sc"
	moistdatacontrol.send( &command, sizeof (command));

#line 349 "GreenhouseArch3Sched.cc"
	__PRF_channelAccess(19131u, sizeof (h1));
...
#line 357 "GreenhouseArch3Sched.cc"
...
#line 375 "GreenhouseArch3Sched.cc"
...
#line 382 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[64u]++ ;

#line 29 "./Monitor.sc"
    while(count <= 29) {

#line 388 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[65u]++ ;
	__PRF_channelAccess(22256u, sizeof (data));
...
#line 398 "GreenhouseArch3Sched.cc"
...
#line 406 "GreenhouseArch3Sched.cc"
...
#line 423 "GreenhouseArch3Sched.cc"
...
#line 430 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[53u]++ ;

#line 48 "./Monitor.sc"
    while(count <= 29) {

#line 436 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[54u]++ ;
	__PRF_channelAccess(20256u, sizeof (data));
...
#line 446 "GreenhouseArch3Sched.cc"
...
#line 454 "GreenhouseArch3Sched.cc"
...
#line 471 "GreenhouseArch3Sched.cc"
...
#line 478 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[5u]++ ;

#line 68 "./Monitor.sc"
    while(count <= 29) {

#line 484 "GreenhouseArch3Sched.cc"
...
#line 491 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[7u]++ ;

#line 70 "./Monitor.sc"
	if (data == 1)

#line 497 "GreenhouseArch3Sched.cc"
	{   
...
#line 506 "GreenhouseArch3Sched.cc"
	{   
...
#line 514 "GreenhouseArch3Sched.cc"
...
#line 521 "GreenhouseArch3Sched.cc"
...
#line 529 "GreenhouseArch3Sched.cc"
...
#line 546 "GreenhouseArch3Sched.cc"
...
#line 553 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[25u]++ ;

#line 91 "./Monitor.sc"
    while(count <= 29) {

#line 559 "GreenhouseArch3Sched.cc"
...
#line 566 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[27u]++ ;

#line 93 "./Monitor.sc"
	if (data == 1)

#line 572 "GreenhouseArch3Sched.cc"
	{   
...
#line 581 "GreenhouseArch3Sched.cc"
	{   
...
#line 589 "GreenhouseArch3Sched.cc"
...
#line 596 "GreenhouseArch3Sched.cc"
...
#line 604 "GreenhouseArch3Sched.cc"
...
#line 623 "GreenhouseArch3Sched.cc"
...
#line 635 "GreenhouseArch3Sched.cc"
...
#line 651 "GreenhouseArch3Sched.cc"
...
#line 660 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[58u]++ ;
	__PRF_channelAccess(21256u, sizeof (h));

#line 20 "./SprinklerControl.sc"
	moistdatain.receive( &h, sizeof (h));

#line 667 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[59u]++ ;

#line 21 "./SprinklerControl.sc"
	if (h == 0)

#line 673 "GreenhouseArch3Sched.cc"
	{   
...
#line 682 "GreenhouseArch3Sched.cc"
	{   
...
#line 690 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[62u]++ ;

#line 25 "./SprinklerControl.sc"
	_specc::waitfor((10));

#line 696 "GreenhouseArch3Sched.cc"
	__PRF_channelAccess(21129u, sizeof (command));
...
#line 704 "GreenhouseArch3Sched.cc"
...
#line 721 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[33u]++ ;

#line 25 "./Stimulus.sc"
    f1 = fopen("tempin.txt", "r");

#line 727 "GreenhouseArch3Sched.cc"
...
#line 734 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[35u]++ ;

#line 29 "./Stimulus.sc"
	fscanf(f1, "%d",  &t1);

#line 740 "GreenhouseArch3Sched.cc"
	__PRF_channelAccess(16128u, sizeof (t1));

#line 30 "./Stimulus.sc"
	TSENSE.send( &t1, sizeof (t1));
    }

#line 747 "GreenhouseArch3Sched.cc"
...
#line 754 "GreenhouseArch3Sched.cc"
...
#line 771 "GreenhouseArch3Sched.cc"
    __PRF_globalCounter[14u]++ ;

#line 44 "./Stimulus.sc"
    f1 = fopen("moistin.txt", "r");

#line 777 "GreenhouseArch3Sched.cc"
...
#line 784 "GreenhouseArch3Sched.cc"
	__PRF_globalCounter[16u]++ ;

#line 48 "./Stimulus.sc"
	fscanf(f1, "%d",  &t1);

#line 790 "GreenhouseArch3Sched.cc"
...
#line 797 "GreenhouseArch3Sched.cc"
...
#line 804 "GreenhouseArch3Sched.cc"
...
#line 824 "GreenhouseArch3Sched.cc"
...
#line 835 "GreenhouseArch3Sched.cc"
    __PRF_channelAccess(17128u, sizeof (convertedtempdata));
...
#line 845 "GreenhouseArch3Sched.cc"
    __PRF_channelAccess(17128u, sizeof (convertedmoistdata));

#line 76 "./Stimulus.sc"
    USERSET.send( &convertedmoistdata, sizeof (convertedmoistdata));
}

#line 852 "GreenhouseArch3Sched.cc"
...
#line 870 "GreenhouseArch3Sched.cc"
...
#line 881 "GreenhouseArch3Sched.cc"
...
#line 912 "GreenhouseArch3Sched.cc"
...
#line 934 "GreenhouseArch3Sched.cc"
	{   
...
#line 942 "GreenhouseArch3Sched.cc"
...
#line 949 "GreenhouseArch3Sched.cc"
...
#line 957 "GreenhouseArch3Sched.cc"
...
#line 989 "GreenhouseArch3Sched.cc"
    __PRF_startProfiler("GreenhouseArch3Sched_bb_counter.prf", "GreenhouseArch3Sched_fn_counter.prf", 
...
#line 997 "GreenhouseArch3Sched.cc"
...
Motorola_DSP56600_0_DSP1::Motorola_DSP56600_0_DSP1(unsigned int _idcnt, i_receiver (&tempin), i_sender (&heatcontrolout), i_sender (&tempout), i_receiver (&Tempsetin))
...
Motorola_DSP56600_0_DSP2::Motorola_DSP56600_0_DSP2(unsigned int _idcnt, i_receiver (&moisturein), i_sender (&sprinklercontrolout), i_sender (&moistureout), i_receiver (&Moisturesetin))
...
{   
    ...
    _specc::waitfor(0ull);
    __PRF_channelAccess(13256u, sizeof (tSetting));
    settingsin.receive( &tSetting, sizeof (tSetting));
    printf("Temp Setting: %i\n", tSetting);
    __PRF_channelAccess(13256u, sizeof (mSetting));
    settingsin.receive( &mSetting, sizeof (mSetting));
    __PRF_channelAccess(13129u, sizeof (tSetting));
    tempsetout.send( &tSetting, sizeof (tSetting));
    __PRF_channelAccess(13130u, sizeof (mSetting));
...
//////////////////////////////////////////////////////////////////////
// End of file GreenhouseArch3Sched.cc
//////////////////////////////////////////////////////////////////////
